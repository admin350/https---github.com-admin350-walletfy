...
import { Landmark, ArrowRightLeft, Wallet, Scale } from "lucide-react";
            ...
            <Card>
                ...
                <CardContent>
                    <p className="text-muted-foreground">
                        Ve a la sección de <a href="/dashboard/bank-accounts" className="text-primary underline">Cuentas Bancarias</a>, edita una cuenta existente o crea una nueva, y en el campo "Propósito de la Cuenta", selecciona "Cartera Tributaria".
                    </p>
                </CardContent>
            </Card>
        )
