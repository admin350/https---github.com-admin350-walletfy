...
import { Banknote, Landmark, CreditCard, Repeat, ClipboardPen, PiggyBank, Wallet, List, Scale, Globe, Calendar, FileText } from "lucide-react";
...
const quickAccessItems = [
    ...
    { href: "/dashboard/calendar", icon: Calendar, label: "Calendario", color: "text-amber-400", shadow: "hover:shadow-[0_0_15px_#facc15]" },
    ...
    { href: "/dashboard/reports", icon: FileText, label: "Informes IA", color: "text-gray-400", shadow: "hover:shadow-[0_0_15px_#9ca3af]" },
];
